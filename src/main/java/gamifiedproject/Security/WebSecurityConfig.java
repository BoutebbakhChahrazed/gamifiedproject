package gamifiedproject.Security;
...
public class WebSecurityConfig {
    ...
    private static final String[] WHITE_LIST_URL = {"/api/v1/auth/**","/api/v1/student/**","/api/v1/admin/**","/api/v1/specialist/**"
        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers("/api/v1/specialiste/**")
                                .hasAnyRole(Role.SPECIALIST.name())
